...
//   Not required when using Pinpoint IMU
    ...
    //----------------------------------------------------------------------------------------------------------------------
    // Downsampled Writer is used for used for logging a robot's pose data for later analysis and debugging.
    ...
    } // end constructor for MecanumDrive
